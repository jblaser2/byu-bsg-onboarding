...
I was a research assistant in Dr. Hart's group from **2023 to 2026.**

Here's the honest truth: pretty much *everything* I did over those three years was completely new
to me. When I first joined the group, I felt completely lost — I had a headache for like three
months straight. 😵‍💫
...
1. **Start here, then read [The Supercomputer](getting-started.md).** It's the first concrete,
   practical thing to set up.
2. **Skim [Understanding CryoEM](cryoem.md) and [Machine Learning](machine-learning.md).** You
